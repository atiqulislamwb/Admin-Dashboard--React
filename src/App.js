    ...
    <div className={currentMode === "Dark" ? "dark" : " "}>
      <BrowserRouter>
        <div className="flex relative dark:bg-main-dark-bg">
          <div className="fixed right-4 bottom-4" style={{ zIndex: "100000" }}>
            <TooltipComponent content="Settings" position="Top">
              <button
                ...
                className="text-3xl text-blue-800 p-3 hover:drop-shadow-xl hover:bg-light-gray"
              >
                <FiSettings />
              </button>
            </TooltipComponent>
          ...
          {activeMenu ? (
            <div className="w-72 fixed left-0 sidebar dark:bg-secondary-dark-bg bg-white ">
              <Sidebar />
            </div>
          ) : (
